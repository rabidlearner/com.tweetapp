    ...
    public class UsersService : IUsersService
    {
        ...
        public User Login()
        {
            ...
            while(isValid)
            {
                ...
                {
                    Console.WriteLine("Please enter valid Email - Ex: manoj@gmail.com");
        ...
        {            
            ...
            {
                Console.WriteLine("Please enter Valid First Name - Ex: Manoj");
                firstName = Console.ReadLine();
            }
            while(validator.ValidateName(lastName))
            {
                Console.WriteLine("Please enter Valid Last Name - Ex:Kumar");
